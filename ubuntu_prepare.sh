...
echo "****Se tiene que reinicar el terminal para seguir con la instalación de odoo, recuerde ejecutar odoo_install.sh para terminar la instalación una vez reiniciada la conexión por ssh****"
echo "Fin del Script"
echo ""
